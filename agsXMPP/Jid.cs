...
#endif
{
    ...
    /// </summary>
    /// <param name="jid">
    /// XMPP ID, in string form examples: user@server/Resource, user@server
    /// </param>
    ...
    /// </summary>
    /// <param name="fullJid">
    /// jis to parse as string
    /// </param>
    /// <returns>
    /// true if the jid could be parsed, false if an error occured
    /// </returns>
    ...
    public static Jid Empty = new(string.Empty);
