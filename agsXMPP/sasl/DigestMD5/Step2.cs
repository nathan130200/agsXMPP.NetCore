...
public class Step2 : Step1
{
    ...
    {
        byte[] hash = MD5.HashData(Encoding.Default.GetBytes(text));
    ...
    public void GenerateResponse()
    {
        ...
        H1 = MD5.HashData(Encoding.UTF8.GetBytes(sb.ToString()));
        ...
        p1 = Hash.Hex(H1).ToLower();
        p2 = Hash.Hex(H2).ToLower();
        ...
        H3 = MD5.HashData(Encoding.ASCII.GetBytes(A3));

        m_Response = Hash.Hex(H3).ToLower();
    }
