...
public abstract class Encoding
{
    ...
    /// <returns>
    /// </returns>
    /// <exception cref="EmptyTokenException">
    /// </exception>
    /// <exception cref="PartialTokenException">
    /// </exception>
    /// <exception cref="ExtensibleTokenException">
    /// </exception>
    /// <exception cref="InvalidTokenException">
    /// </exception>
    /// <exception cref="PartialCharException">
    /// </exception>
    ...
    /// <exception cref="PartialTokenException">
    /// </exception>
    /// <exception cref="EndOfPrologException">
    /// </exception>
    /// <exception cref="InvalidTokenException">
    /// </exception>
    /// <exception cref="ExtensibleTokenException">
    ...
    public string getPublicId(byte[] buf, int off, int end)
    {
        ...
        {
            var c = (char) byteToAscii(buf, off);
            switch (byteType(buf, off))
            {
                case BT_MINUS:
                case BT_APOS:
