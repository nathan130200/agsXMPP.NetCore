...
public class Element : Node
{
    ...
    /// <summary>
    /// </summary>
    private readonly Text m_Value = new();
    ...
    /// </param>
    /// <returns>
    /// true when existing and removed, false when not existing
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// Type of the tag that should be removed
    /// </param>
    /// <returns>
    /// true when existing and removed, false when not existing
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// Type of the tags that should be removed
    /// </param>
    /// <returns>
    /// true when tags were removed, false when no tags were found and removed
    /// </returns>
    ...
    /// </summary>
    /// <param name="name">
    /// name of Attribute to add/change
    /// </param>
    /// <param name="rawValue">
    /// </param>
    public void SetAttribute(string name, object rawValue)
    {
        lock (m_Attributes)
        {
            if (rawValue == null)
                ...
                m_Attributes[name] = Convert.ToString(rawValue, CultureInfo.InvariantCulture);
        }
    }
    ...
    {
        lock (m_Attributes)
            m_Attributes[name] = val ? "true" : "false";
    }
    ...
    {
        SetAttribute(name, rawValue: value.ToString(ifp));
    }
    ...
    /// </param>
    /// <param name="traverseChildren">
    /// when set to true then the function traverses the whole tree
    /// </param>
    /// <returns>
    /// </returns>
    ...
    public override object Clone()
    {
        ...
        clone.m_Attributes = new Dictionary<string, string>();

        foreach (var (key, value) in m_Attributes)
            clone.m_Attributes[key] = value;
