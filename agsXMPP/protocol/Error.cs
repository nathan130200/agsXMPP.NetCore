...
public class Error : Element
{
    ...
    */
        ...
        set
        {
            switch (value)
            {
                case StreamErrorCondition.BadFormat:
                    SetTag("bad-format", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.BadNamespacePrefix:
                    SetTag("bad-namespace-prefix", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.Conflict:
                    SetTag("conflict", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.ConnectionTimeout:
                    SetTag("connection-timeout", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.HostGone:
                    SetTag("host-gone", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.HostUnknown:
                    SetTag("host-unknown", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.ImproperAddressing:
                    SetTag("improper-addressing", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.InternalServerError:
                    SetTag("internal-server-error", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.InvalidFrom:
                    SetTag("invalid-from", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.InvalidId:
                    SetTag("invalid-id", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.InvalidNamespace:
                    SetTag("invalid-namespace", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.InvalidXml:
                    SetTag("invalid-xml", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.NotAuthorized:
                    SetTag("not-authorized", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.PolicyViolation:
                    SetTag("policy-violation", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.RemoteConnectionFailed:
                    SetTag("remote-connection-failed", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.ResourceConstraint:
                    SetTag("resource-constraint", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.RestrictedXml:
                    SetTag("restricted-xml", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.SeeOtherHost:
                    SetTag("see-other-host", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.SystemShutdown:
                    SetTag("system-shutdown", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.UndefinedCondition:
                    SetTag("undefined-condition", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.UnsupportedEncoding:
                    SetTag("unsupported-encoding", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.UnsupportedStanzaType:
                    SetTag("unsupported-stanza-type", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.UnsupportedVersion:
                    SetTag("unsupported-version", string.Empty, Namespaces.STREAMS);
                    break;
                case StreamErrorCondition.XmlNotWellFormed:
                    SetTag("xml-not-well-formed", string.Empty, Namespaces.STREAMS);
                    break;
                default:
                    return;
            }
    ...
    public string Text
    {
        ...
        set { SetTag("text", value, Namespaces.STREAMS); }
    }
