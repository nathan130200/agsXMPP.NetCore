    ...
    */
    ...
    public void WriteCall(string name, ArrayList Params)
    {
        ...
        if (Params != null && Params.Count > 0)
        {
            ...
            RemoveTag("params");
            Element elParams = new("params");                
            
            for (int i = 0; i < Params.Count; i++)
            {
                Element param = new("param");                                      
    ...
    {            
        ...
        {
            NumberFormatInfo numberInfo = new()
            {
